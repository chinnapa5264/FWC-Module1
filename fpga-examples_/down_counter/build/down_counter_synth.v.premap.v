...
module down_counter(\in_data(0) , \in_data(1) , \in_data(2) , \in_data(3) , \in_data(4) , \in_data(5) , \in_data(6) , \in_data(7) , latch, dec, div, \count(0) , \count(1) , \count(2) , \count(3) , \count(4) , \count(5) , \count(6) , \count(7) , clk, zero);
  ...
  (* module_not_derived = 32'd1 *)
  (* src = "/data/data/com.termux/files/home/fpga-examples/./down_counter/down_counter.v:31.1-39.4|/data/data/com.termux/files/home/symbiflow/bin/../share/yosys/quicklogic/pp3_ffs_map.v:14.9-14.50" *)
  dff count_dff_Q (
    .CLK(_00_),
    .D(\latch_LUT3_I0_O(7) ),
    .Q(_08_)
  ...
  (* module_not_derived = 32'd1 *)
  (* src = "/data/data/com.termux/files/home/fpga-examples/./down_counter/down_counter.v:21.1-29.4|/data/data/com.termux/files/home/symbiflow/bin/../share/yosys/quicklogic/pp3_ffs_map.v:14.9-14.50" *)
  dff delay_dff_Q (
    .CLK(sys_clk),
  ...
  (* module_not_derived = 32'd1 *)
  (* src = "/data/data/com.termux/files/home/fpga-examples/./down_counter/down_counter.v:17.21-19.2" *)
